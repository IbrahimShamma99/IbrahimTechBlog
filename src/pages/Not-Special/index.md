...
<span style="background-color: rgba(0,0,0, 0.65) ">استقل عاطفيا</span>
يعني لما تشوف قديش الناس مبسوطة و بتسافر العالم على السوشال ميديا مش تتذمر و تضايق لازم تكون متيقن انه اللي ببين سعيد هم اكثر الناس بؤس. ما رح 

<span style="background-color: rgba(0,0,0, 0.65) ">اعادة هيكلة لعلاقتك بالبيت</span>
